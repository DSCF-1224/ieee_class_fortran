...
fypp -F -DMODE=1 test_set_ieee_X.fypp         test_set_ieee_negative_inf.f90
fypp -F -DMODE=2 test_set_ieee_X.fypp         test_set_ieee_negative_zero.f90
fypp -F -DMODE=3 test_set_ieee_X.fypp         test_set_ieee_positive_zero.f90
fypp -F -DMODE=4 test_set_ieee_X.fypp         test_set_ieee_positive_inf.f90
fypp -F -DMODE=5 test_set_ieee_X.fypp         test_set_ieee_quiet_nan.f90
fypp -F -DMODE=6 test_set_ieee_X.fypp         test_set_ieee_signaling_nan.f90
